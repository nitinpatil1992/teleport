...
type NewWebSessionRequest struct {
	...
	// This flag is used to preserve the first session's expiration time
	// so users can switch back to their default roles (from assuming access request approved roles)
